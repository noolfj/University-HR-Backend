...
if( $_SERVER["REQUEST_METHOD"] == "POST" ){
  ...
  if( !empty($Username) && !empty($pass) ){
    ...
    $sql_query = "SELECT * FROM employees WHERE Username='$Username' && Password = '$pass'  ";
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($rows = mysqli_fetch_assoc($result)) {
            ...
            if ($rows["User_Role_Id"] === "1") {
                ...
                header("Location: HR/index.php?login-sucess");
                exit;
            } elseif ($rows["User_Role_Id"] === "2") {
                header("Location: Personal/index.php?login-sucess");
                exit;
            } else {
...
h2 {
    ...
    <h2 class="text-center text-black">Управление персоналом в учебном завдении</h2>
                        ...
                        <div class="card-body pt-5">
                            <div class="p-2">
                                <form class="form-horizontal"  method="POST" action=" <?php htmlspecialchars($_SERVER['PHP_SELF']) ?>">
                                    ...
                                    <div class="mt-3">
                                        <button class="btn btn-primary w-100 waves-effect waves-light" type="submit" name="signin">
                                            Войти</button>
                                    </div>
