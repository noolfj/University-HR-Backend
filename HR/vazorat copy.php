                        ...
                        <div class="table-responsive">
                            <table class="table mb-0 table-bordered border-2">
                                ...
                                <thead>
                                    ...
                                    <th style="width: 15%; background-color: #4671D5; color: white;" colspan="3">то 20
                                        балл</th>
                                </thead>
                                <tbody>
                                ...
                                <tbody>
                                    <tr>
                                        <td rowspan="5">1.2</td>
                                        <td rowspan="5">Ғолибият дар озмун ва мусобиқаҳои тахассусӣ (сертификат, маводи
                                            тасдиқкунанда)</td>
                                        <td>Сатҳи душвор</td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td rowspan="5">1.4</td>
                                        <td rowspan="5">Маводи таълимӣ-методӣ (маводҳои дарсҳои озмоиши ва мустақилона),
                                            ҷ.ч.</td>
                                        <td>>6, нашршуда</td>
                                ...
                                <thead>
                                    <th style="width: 30%; background-color: #4671D5; color: white;" colspan="2">
                                        2. Фаъолияти илмӣ</th>
                                    <th style="width: 15%; background-color: #4671D5; color: white;" colspan="3">то 23
                                        балл</th>
                                </thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td rowspan="5">2.4</td>
                                        <td rowspan="5">Мақолаҳо дар маҷаллаҳои КОА/ Паёми донишкада (нашршуда) </td>
                                        <td>≥4 КОА</td>
                                        <td style="color: red;">4</td>
                                        <td rowspan="5">
                                            <input type="number" name="omuzgor"><br>
                                ...
                                <thead>
                                    ...
                                    <th style="width: 15%; background-color: #4671D5; color: white;" colspan="3">то 17
                                        балл</th>
                                </thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td rowspan="5">3.2</td>
                                        <td rowspan="5">Фаъолнокии назаррас дар корҳои тарбиявӣ-сиёсӣ (миқдори мақола ва
                                            вокунишҳо)</td>
                                        <td>≥10</td>
                                        <td style="color: red;">2,5</td>
                                        <td rowspan="5">
                                ...
                                <tbody>
                                    <tr>
                                        <td>3.7</td>
                                        <td>Ташкил ва гузаронидани маҳфилҳо, чорабиниҳо, озмун ва мусобиқаҳои ташаббусӣ
                                            барои донишҷӯён </td>
                                        <td>-</td>
                                        <td style="color: red;">1,5</td>
                                        <td>
                                ...
                                <tbody>
                                    <tr>
                                        <td>3.9</td>
                                        <td>Дараҷаи омодагии донишҷӯ ба дарс мувофиқи қоидаҳои тартиботи дохилӣ (тафтиши
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td rowspan="5">4.7</td>
                                        <td rowspan="5">Роҳбарӣ ба омодасозии ғолибияти донишҷӯ дар Озмунҳои фаннӣ ва
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td rowspan="5">5.1</td>
                                        <td rowspan="5">Ҷалби маблағҳои гранти байналмиллалӣ ва ҷумҳуриявӣ барои рушди
                                            донишкада </td>
                                        <td>-</td>
                                        <td style="color: red;">4</td>
                                        <td rowspan="5">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td rowspan="5">5.4</td>
                                        <td rowspan="5">Мусоидат ба сармоягузорӣ аз тарафи хатмкунандагон ва кордеҳон
                                        </td>
                                        <td>-</td>
                                        <td style="color: red;">1</td>
                                        <td rowspan="5">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td rowspan="5">5.6</td>
                                        <td rowspan="5">Санад оиди ҷоришавии навоварӣ дар истеҳсолот бо патент (аз он
                                            ҷумла ихтироъ, навоварӣ, шаҳодатномаи зеҳнӣ ва нахустпатент), миқдор </td>
                                        <td>Санад+патент</td>
                                        <td style="color: red;">4</td>
                                        <td rowspan="5">
                                            <input type="number" name="omuzgor"><br>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td rowspan="5">5.9</td>
                                        <td rowspan="5">Таҷрибаомӯзии илмӣ/такмили ихтисос (сертификати ДМТ) ва дорандаи
                                            гранти инфиродӣ
                                        </td>
                                        <td>-</td>
                                        <td style="color: red;">1</td>
