                            ...
                            <div class="dropdown d-inline-block">
                                <button type="button" class="btn header-item waves-effect"
                                    ...
                                    <img class="rounded-circle header-profile-user"
                                        src="../Personal/upload/<?php if(!empty($Path_Photo)){ echo $Path_Photo; }else{ echo "Admin.png"; } ?>" alt="Header Avatar">
            ...
            <div class="vertical-menu">
                ...
                <div class="h-100">
                    ...
                    <div class="user-wid text-center py-4">
                        <div class="user-img">
                            <img src="../Personal/upload/<?php if(!empty($Path_Photo)){ echo $Path_Photo; }else{ echo "Admin.png"; } ?>" alt=""
